						...
						<br /><br />
							...
							<div class="form-group">
								...
								<?php if($role == '2' || $role=='1') { ?>
									<option value="front_page">Selamat Datang</option>
									<option value="front_page">Publikasi</option>
								...
								<?php if($role=='1' || $role=='3'){ ?>
									<option value="unggulan">Unggulan (Produk Unggulan Desa)</option>
									<option value="arsip">Arsip (Arsip Desa Online)</option>
								<?php } ?>
								</select>
                            </div>
							<div class="form-group">
                                ...
                                <select name="position" class="form-control">
									...
									<?php if($role == '2' || $role=='1') { ?>
									<option value="top">Selamat Datang</option>
									<option value="front_page">Publikasi</option>
									<option value="front_page">Pemerintahan</option>
									...
									<?php } ?>
									<?php if($role == '3' || $role=='1') { ?>
									<option value="bottom">Bawah (Unggulan & Arsip)</option>
									<?php } ?>
								</select>
                            </div>
							<div class="form-group">
