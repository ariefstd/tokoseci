          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Tambah isi Arsip Online</h4>
              </div>
              <div class="modal-body">
			  
					<form id="editKey" action="<?php echo base_url() ?>addNewArsip" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6-">                                
                                    <div class="form-group">
								...
								<div class="col-md-6-">
                                    <div class="form-group">
										...
										<input type="hidden" class="form-control" id="author" placeholder="Nama Penulis" name="category" value="arsip" maxlength="10">
                                    </div>
                                </div> 
                            </div>
