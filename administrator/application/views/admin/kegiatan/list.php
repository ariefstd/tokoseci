          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Tambah Artikel Berita Kegiatan</h4>
              </div>
              <div class="modal-body">
			  
					<form id="editKey" action="<?php echo base_url() ?>addNewKegiatan" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6-">                                
                                    <div class="form-group">
                                        <label>Judul artikel kegiatan</label>
                                ...
                                <div class="col-md-6-">
                                    <div class="form-group">
                                        <label>Key artikel kegiatan</label>
								...
								<div class="col-md-6-">
                                    <div class="form-group">
                                        <label>Penulis artikel kegiatan</label>
								...
								<div class="col-md-6-">
                                    <div class="form-group">
                                        <label valign="top">Berita artikel kegiatan</label>
										<!--
										...
										-->
										<?php //echo form_open('addNewKegiatan');?> 
										<?php echo $this->ckeditor->editor('berita',@$default_value);?> 
										<?php echo form_error('berita','<p class="error">'); ?>
										
										<?php //echo form_close();?>
										
										<input type="hidden" class="form-control" id="author" placeholder="Nama Penulis" name="category" value="kegiatan" maxlength="10">
                                    </div>
                                </div> 
                            </div>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "Kegiatan/" + value);
