	...
	<section class="content" style="background:#ffffff">
		<div class="row">
			...
			<div class="container top">
			  ...
			  <ul class="breadcrumb">
				<li>
				  <a href="<?php echo site_url("artikelDepan"); ?>">
					Artikel <?php //echo ucfirst($this->uri->segment(1));?>
				  </a>
				</li>
				<li>
			...
			<div class="col-md-8">
				<div class="box box-primary-">
                    ...
                    <form role="form" action="<?php echo base_url() ?>artikelDepan/add" method="post" id="editKey" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6-">                                
                            ...
                            <div class="row">
								<div class="col-md-9-">
                                    <div class="form-group">
                                        <label>Posisi artikel</label>
                                        <select name="position" class="form-control">
											<option value="front_page">Berita Utama</option>
											<option value="body">Berita Tambahan</option>
											<option value="body">Berita Terbaru</option>
										</select>
                                    </div>
                                </div>
                                <div class="col-md-6-">
                                    <div class="form-group">
										...
										<input type="hidden" class="form-control" id="author" placeholder="Nama Penulis" name="category" value="<?php echo "front_page"; ?>" maxlength="10">
                                    </div>
                                </div>
                                <div class="col-md-6-">
                                    <div class="form-group">
