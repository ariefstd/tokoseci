                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
						  <?php
							echo '<a class="btn btn-sm btn-info" href="'.site_url("Pemerintahan").'/update/'.$record->id.'" ><i class="fa fa-pencil"></i></a>';
						  ?>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Tambah Artikel Berita Pemerintahan</h4>
              </div>
              <div class="modal-body">
			  
					<form id="editKey" action="<?php echo base_url() ?>addNewPemerintahan" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6-">                                
                                    <div class="form-group">
                                        <label>Judul artikel Pemerintahan</label>
                                ...
                                <div class="col-md-6-">
                                    <div class="form-group">
                                        <label>Key artikel Pemerintahan</label>
								...
								<div class="col-md-6-">
                                    <div class="form-group">
                                        <label>Penulis artikel Pemerintahan</label>
								...
								<div class="col-md-6-">
                                    <div class="form-group">
                                        <label valign="top">Berita artikel Pemerintahan</label>
										...
										<input type="hidden" class="form-control" id="author" placeholder="Nama Penulis" name="category" value="pemerintahan" maxlength="10">
                                    </div>
                                </div> 
                            </div>
							<!--
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "Pemerintahan/" + value);
