                                ...
                                <div class="col-md-7">
                                    <div class="ct-productCustomization">
                                        ...
                                        <div class="ct-price">
                                            ...
                                            <span class="ct-u-colorBlack ct-u-size40">Rp. <?php echo $price ?></span>
                                        ...
                                        <form action="<?php echo base_url(); ?>shopping/add_detail" method="post">
                                            ...
                                            <div class="ct-productQuantity">
                                                <div class="ct-u-size16 ct-u-paddingBottom10">Banyaknya barang:</div>
                                                <div class="">													
										...
										<p>Permainan kayu pilihan. Disususn denga menggunakan bahan terpilih, bahan yang digunakan tidak berbahaya dan aman digunakan anak-anak.<br>
...
<!--                                            -->
                ...
                <h4 class="ct-headerBox text-left ct-u-borderBottom3 ct-u-paddingBottom15 ct-u-paddingTop55">Tidak ada barang yang dipilih</h4>
                                ...
                                <div class="ct-productShop-content">
                                    <div class="ct-productShop-content-description">
                                        <a href="<?php echo base_url() ?>productdetail/<?php echo $id ?>">
                                            <h3><?php echo $name; ?></h3>
                                            <span><del>Rp. <?php echo $old_price ?></del> Rp. <?php echo $price ?></span>
                                        </a>
