                    ...
                    <div class="ct-topBar-basket">
                        ...
                        <div class="ct-topBar-basket-info">
                            <div class="ct-cartItem">
                                <a href="single-product.html">
                                    <div class="ct-cartItem-image pull-left">
                                        <img src="<?php echo base_url() ?>images/shop-cart-ring1.png" alt="">
                                    </div>
                            ...
                            <div class="ct-cartItem">
                                <a href="single-product.html">
                                    <div class="ct-cartItem-image pull-left">
                                        <img src="<?php echo base_url() ?>images/shop-cart-ring2.png" alt="">
                                    </div>
                                    <div class="ct-cartItem-title">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 hidden-sm">
                                                <div class="ct-collectionRightPicture">
                                                    <img src="<?php echo base_url() ?>images/main-menu-collection-right-bg.png" alt="Picture">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-7">
                                    <div class="ct-productCustomization">
                                        ...
                                        <div class="ct-price">
                                            ...
                                            <span class="ct-u-colorBlack ct-u-size40">$289.00</span>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane" id="reviews">
                                    <div class="ct-reviewImageBox">
                                        <img src="<?php echo base_url() ?>images/review-image.jpg" alt="Review Image">
                                    </div>
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="ct-question">
                                                                    <div class="ct-questionDescription">
                                                                        ...
                                                                        <p class="text-justify">If so, please let me know if it fit. I called to request an additional link and they said no. Many years ago I ended up buying 2 of the watch I wanted so I could add links but I won't do that again. I am shocked they didn't make this in an 8" or a little bigger since the large in other watches and bracelets always sell out. Thanks to anybody that can help!</p>
                                                                    </div>
                                                                    <div class="ct-questionImage">
                                                                        <a href="#">
                                                                            <img src="<?php echo base_url() ?>images/user-rounded-image.jpg" class="img-rounded" alt="User Rounded Image">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="ct-videoProduct is-active">
                                                <img src="<?php echo base_url() ?>images/video-image-1-small.jpg" alt="Video 1">
                                            ...
                                            <div class="ct-videoProduct">
                                                <img src="<?php echo base_url() ?>images/video-image-2-small.jpg" alt="Video 2">
                                                <div class="ct-videoProduct-description">
                                            ...
                                            <div class="ct-videoProduct">
                                                <img src="<?php echo base_url() ?>images/video-image-3-small.jpg" alt="Video 3">
                                                <div class="ct-videoProduct-description">
