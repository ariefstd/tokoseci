            ...
            <nav class="navbar yamm">
                <div class="container">
                    <ul class="nav navbar-nav ct-navbar--fadeIn">
                                    ...
                                    <div class="yamm-content">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-6">
                                                <h5 class="text-uppercase"><strong>Toko SECI</strong><br><small>online</small></h5>
                                                <ul class="list-unstyled">
                                                    <li><a href="<?php //echo base_url()?>v/huruf"><i class="fa fa-angle-right fa-fw"></i> Huruf-huruf Ajaib</a></li>
                                                    <li><a href="<?php //echo base_url()?>v/angka"><i class="fa fa-angle-right fa-fw"></i> Angka yang pintar</a></li>
                                                    <li><a href="<?php //echo base_url()?>v/pesan"><i class="fa fa-angle-right fa-fw"></i> Pesan yang bermanfaat</a></li>
                                            ...
                                            <div class="col-md-4 hidden-sm">
                                                <div class="ct-collectionRightPicture">
                                                    <img src="<?php //echo base_url() ?>images/background.jpg" alt="">
                                                </div>
                                            </div>
											-->
											<!--
						...
						<!--
                        <li class="dropdown">
                            <a href="#"><i class="fa fa-building-o fa-fw"></i> Koleksi Permainans</a>
							<ul class="dropdown-menu">
								<li><a href="<?php echo base_url()?>v/puzzle"><i class="fa fa-angle-right fa-fw"></i> Permainan Puzzle</a></li>
								<li><a href="<?php echo base_url()?>v/tradisional"><i class="fa fa-angle-right fa-fw"></i> Permainan Tradisional</a></li>
								<li><a href="<?php echo base_url()?>v/modern"><i class="fa fa-angle-right fa-fw"></i> Permainan Modern</a></li>
						...
						<li class="dropdown">
                            <a href="#">Kontak</a>
							<ul class="dropdown-menu">
								<li><a href="<?php echo base_url() ?>contact/">Alamat Toko Kami</a></li>
								<li><a href="#">Peta Petunjuk Lokasi</a></li>
							</ul>
                        </li>                        
                    </ul>
                    ...
                    <div class="ct-navbar-search">
                        ...
                        <form id="form_pencarian" name="form_pencarian" method="post" action="<?php echo base_url();?>search/">
                            <table width="100%">
                            <tr>
                                <td width="90%">
								<input name="ringkasan" type="text" id="ringkasan" style="width:100%" class="form-control" value="<?php //echo $ringkasan;?>"/></td>
                                <td><input name="submit" type="submit" id="submit" value="Pencarian..." class="ct-navbar-search-button" style="float: left"/> </td>
                            </tr>
                            </table>
                        </form>
