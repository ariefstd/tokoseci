            ...
            <div class="container">
                <div class="ct-topBar-navigation pull-left">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="<?php echo base_url() ?>register/"><i class="fa fa-fw fa-pencil"></i> Create an account</a></li>
                    </ul>
                </div>
                ...
                <div class="ct-header ct-header--default ct-u-paddingTop30 ct-u-paddingBottom50">
                    <div class="ct-header-navigation">
                        <ul class="list-unstyled list-inline">
                            <li><a href="<?php echo base_url() ?>cart/">My Account</a></li>
                    <?php
                    if(!$this->session->userdata('is_logged_in')){ ?>                      
                        <li><a href="<?php echo base_url(); ?>mycart/">Checkout</a></li>
                    <?php }else{ ?>
                ...
                <div class="row">
                    ...
                    if(!$this->session->userdata('is_logged_in')){ ?> 
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                <th>Address</th>
                                <td>Taman Kerti Residence unit 7, Seminyak</td>
                            </tr>
                            <tr>
                                <th>City</th>
                                <td>Badung</td>
                        ...
                        <form class="ct-u-paddingTop10" action="#">
                            ...
                            <div class="ct-differentShippingAddress is-notActive">
                                <div class="form-group">
                                    ...
                                    <select class="ct-select ct-select--full" id="difcountry" name="country">
                        <?php
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" class="form-control" name="fname" id="diffirstname" >
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="diflastname" class="control-label change-label">Last Name*</label>
                                            <input type="text" class="form-control" name="lname" id="diflastname" >
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="difcompany" class="control-label">Company Name</label>
                                    <input type="text" class="form-control" name="company" id="difcompany" >
                                </div>
                                <div class="form-group">
                                    <label for="difstreetaddress" class="control-label">Your Address*</label>
                                    <input type="text" class="form-control" name="address" id="difstreetaddress" placeholder="Street Address" >
                                    <div class="ct-u-paddingTop10">
                                        <input type="text" class="form-control" name="address2" placeholder="Apartment, Unit, Suite, etc." >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="difcity" class="control-label">Town/City*</label>
                                    <input type="text" class="form-control" name="city" id="difcity" >
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <label for="difregion" class="control-label">State*</label>
                                            <input type="text" class="form-control" name="state" id="city">
                                            <!--
                                            <select class="ct-select ct-select--full" id="difregion" name="state2">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" class="form-control" id="difpostcode" name="zip" >
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" class="ct-select ct-select--full" name="email" id="email" >
                                            <!--
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" class="form-control" name="phone" id="difphone" >
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="notes" class="control-label">Town/City*</label>
                                    <textarea id="notes" class="form-control" rows="4" name="city" placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
                                </div>
                            </div>
                        </form>
                    </div>
