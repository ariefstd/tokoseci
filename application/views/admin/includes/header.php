      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li class="treeview">
              <a href="<?php echo base_url(); ?>Pemerintahan" >
                <i class="fa fa-plane"></i>
                <span>Artikel Pemerintahan</span>
              </a>
            </li>
			<?php } ?>
			<?php
			...
			<li class="treeview">
              <a href="<?php echo base_url(); ?>Dokumentasi" >
                <i class="fa fa-thumb-tack"></i></i>
                <span>Artikel Dokumentasi</span>
              </a>
            </li>
			<?php } ?>
			<?php
