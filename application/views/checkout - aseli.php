...
<input type="hidden" class="form-control" id="lastname" name="lname" value="<?php echo $row->last_name ?>" >
                            ...
                            <tr>
                                <th>Email</th>                               
                                <td>
<input type="hidden" class="form-control" id="email" name="emailaddress" value="<?php echo $email ?>" >
                                <?php echo $email ?></td>                    
                            </tr>
                            <tr>
                                <th>Phone</th>
...
<input type="hidden" class="form-control" id="address" name="address" value="<?php echo $row->address2 ?>" >
                        ...
                        <?php } ?>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" id="lastname" name="lname2" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="address2" id="streetaddress" placeholder="Street Address" >
